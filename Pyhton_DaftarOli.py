...
while jwb=="y" or jwb=="Y":
    ...
    TotalAwalB = TotalAwalA - TotalAwalA*1/100
    #Tahap menghitung diskon
    #mendapatkan diskon ketika pembelian bernilai 200.000
    TotalMinimalSebelumppn = 200000 
    if TotalAwalB < TotalMinimalSebelumppn : 
        TotalAkhir = TotalAwalB - TotalAwalB*5/100
    else:
        TotalAkhir = TotalAwalB
